...
const updateShipping = catchAsync(async (req, res) => {
  const shippingData = req.body;
  const id   = req.params.id
  const result = await shippingServices.updateShippingOnDB(shippingData,id );
...
const deleteShipping = catchAsync(async (req, res) => {
  const id = req.params.id;
  await shippingServices.deleteShippingOnDB(id);
...
const shippingStats = catchAsync(async (req, res) => {
  const id = req.params.id;
 const result =  await shippingServices.shippingStats();
