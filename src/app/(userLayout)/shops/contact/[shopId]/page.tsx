...
const pageData: PageData = {
  ...
  contactInfo: {
    address: {
      text: "Address",
      description:
        "Mirpur aliquod aliquam. Ut rerum recusandae. Labons voluptatibus. 23196. Quis qui dolore ea.",
    },
    phone: {
      number: "532409738648",
  ...
  socialLinks: [
    ...
    },
    {
      ...
      bgColor:
        "linear-gradient(to right, #f58529, #dd2a7b, #8134af)",
      hoverColor: "#dd2a7b",
      icon: "instagram",
    },
    {
  ...
  faqs: [
    {
      ...
      answer:
        "You'll receive a tracking number via email once your order ships. Use this number on our tracking page.",
    },
    {
      question: "Do you offer gift cards?",
      answer:
        "Yes! Digital gift cards are available in various amounts and never expire.",
    },
    {
      question: "What's your return policy?",
      answer:
        "We offer 30-day returns for unworn items with original tags. Visit our returns page for details.",
    },
    {
      question: "How do I change my order?",
      answer:
        "Contact us within 1 hour of placing your order, and we'll do our best to make changes.",
    },
  ],
};
            ...
            <div>
              ...
              <Select>
                <SelectTrigger className="mt-2 w-full">
                  <SelectValue
                    placeholder={form.subjectOptions[0].label}
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <CardContent className="space-y-6 p-0">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{`${shopData?.data?.shopAddress?.streetAddress}, ${shopData?.data?.shopAddress?.city}, ${shopData?.data?.shopAddress?.state}, ${shopData?.data?.shopAddress?.zip}, ${shopData?.data?.shopAddress?.country}`}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600"> {shopData?.data?.shopSetting?.contactNo}</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{shopData?.data?.notificationEmail?.notificationEmail
                  }</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Store Hours open </p>
