...
export default function TermsAndConditions() {
    ...
    useEffect(() => {
        ...
        if (termsData) console.log("✅ Terms Data:", termsData);
        if (error) console.log("❌ Error fetching terms:", error);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 rounded-lg flex flex-col">
