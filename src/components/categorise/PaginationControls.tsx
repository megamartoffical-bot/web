...
export default function PaginationControls({
  ...
  return (
    <div className="flex  sm:flex-row items-center justify-between gap-4 mt-6">
      {/* Previous */}
      <Button
...
function PageButton({
  ...
  return (
    <button
      ...
      className={`min-w-[36px] h-9 sm:min-w-[40px] sm:h-10 rounded-lg border text-sm font-medium transition
        ${
          isActive
