...
const DiscountBanner = () => {
  return (
    <div
      className="relative flex items-center justify-between z-0
     overflow-hidden p-6 md:p-10 bg-gradient-to-r 
      h-28 md:h-[290px] lg:h-[330px] xl:h-[390px] rounded-[16px] md:rounded-lg
