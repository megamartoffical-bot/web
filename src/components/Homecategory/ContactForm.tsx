...
export default function ContactForm() {
    ...
    return (
        <div className="w-full mt-10 bg-white md:rounded-lg p-8 ">
            <h1 className="text-2xl font-semibold text-gray-900 mb-8">Do you have question?</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                    type="submit"
                    className="w-auto bg-gray-900 hover:bg-gray-800 font-semibold text-white px-6 py-2 rounded-lg flex items-center gap-2 transition-colors"
                >
                    Send Message
