...
const getWithdrawalStats = (vendorId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const objectId = new mongoose_2.Types.ObjectId(vendorId);
    const withdrawals = yield withdrawals_model_1.default.aggregate([
        { $match: { vendorId: objectId, isDeleted: { $ne: true } } },
        {
            $group: {
                _id: null,
                requestedBalance: {
    ...
    const requestedBalance = ((_a = withdrawals[0]) === null || _a === void 0 ? void 0 : _a.requestedBalance) || 0;
    const withdrawnBalance = ((_b = withdrawals[0]) === null || _b === void 0 ? void 0 : _b.withdrawnBalance) || 0;
    const revenueData = yield order_model_1.OrderModel.aggregate([
        { $unwind: '$orderInfo' },
        {
            $match: {
                'orderInfo.vendorId': objectId,
                'orderInfo.status': 'delivered', // only completed order
            },
        },
        {
            $group: {
                _id: null,
                revenue: { $sum: '$orderInfo.totalAmount.total' },
            },
        },
    ]);
    const revenue = ((_c = revenueData[0]) === null || _c === void 0 ? void 0 : _c.revenue) || 0;
    // 3️⃣ Final Calculation
    const currentBalance = revenue - (requestedBalance + withdrawnBalance);
    return {
        currentBalance,
        requestedBalance,
        withdrawnBalance,
