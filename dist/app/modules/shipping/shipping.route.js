...
router.patch("/update-shipping/:id", (0, validateRequest_1.default)(shipping_validations_1.updteShippingZodSchema), shipping_controller_1.shippingControllers.updateShipping);
router.delete('/delete-shipping/:id', shipping_controller_1.shippingControllers.deleteShipping);
router.get('/stats/all', shipping_controller_1.shippingControllers.shippingStats);
