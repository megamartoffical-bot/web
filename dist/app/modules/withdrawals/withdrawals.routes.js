...
router.get('/vendor/:id', withdrawals_controller_1.WithdrawalControllers.getVendorsWithdrawal);
router.patch("/update/:id", (0, validateRequest_1.default)(withdrawals_validations_1.createWithdrawalZodSchema.partial()), withdrawals_controller_1.WithdrawalControllers.updateWithdrawal);
router.patch("/:id", withdrawals_controller_1.WithdrawalControllers.deleteWithdrawal);
