...
exports.brandServices = exports.DeleteBrandOnDB = exports.updateBrandOnDB = void 0;
...
const updateBrandOnDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedBrand = yield brands_model_1.BrandModel.findByIdAndUpdate(id, payload, {
        new: true,
        runValidators: true,
    });
    return updatedBrand;
});
exports.updateBrandOnDB = updateBrandOnDB;
const DeleteBrandOnDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const isBrandExists = yield brands_model_1.BrandModel.findById(id);
    if (!isBrandExists) {
        throw new handleAppError_1.default(http_status_1.default.NOT_FOUND, 'Brand not found!');
    }
    const updatedBrand = yield brands_model_1.BrandModel.findByIdAndDelete(id);
    return updatedBrand;
});
