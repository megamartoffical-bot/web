...
exports.bannerServices = exports.deleteBannerFromDB = exports.getAllBannersFromDB = exports.updateBannerFromDB = exports.createBannerFromDB = void 0;
...
const deleteBannerFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const banner = yield banner_model_1.BannerModel.findById(id);
    if (!banner) {
        throw new handleAppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Banner not Found!');
    }
    yield banner_model_1.BannerModel.findByIdAndDelete(id);
    return {
        message: 'Banner deleted successfully!',
    };
});
exports.deleteBannerFromDB = deleteBannerFromDB;
exports.bannerServices = {
    ...
    deleteBannerFromDB: exports.deleteBannerFromDB,
};
